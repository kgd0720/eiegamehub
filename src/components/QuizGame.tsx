...
export default function QuizGame() {
  ...
  if (gameState === 'setup') {
    return (
      <div className="max-w-screen-2xl mx-auto w-full p-[2cm] h-[calc(100vh-100px)] flex flex-col animate-in fade-in duration-1000 font-sans text-slate-800 no-print overflow-x-hidden overflow-y-auto min-h-0 relative">
