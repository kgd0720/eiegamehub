...
export default function QuizGame() {
  ...
  if (gameState === 'setup') {
    return (
      <div className="max-w-screen-2xl mx-auto w-full p-4 md:p-[2cm] h-[calc(100vh-100px)] flex flex-col animate-in fade-in duration-1000 font-sans text-slate-800 no-print overflow-x-hidden overflow-y-auto min-h-0 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-3 bg-white border border-slate-200 rounded-2xl px-4 py-3 shadow-sm">
           <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-[1000] italic uppercase tracking-tighter text-slate-900 leading-none mb-1 whitespace-nowrap">퀴즈맞추기 설정</h1>
           ...
           <div className="flex items-center gap-2 px-4 py-1.5 shrink-0 bg-rose-50 border border-rose-100 rounded-full">
                ...
                <div className="flex flex-col flex-1 min-h-0 gap-3">
                   ...
                   <div className="bg-slate-50 border border-slate-100 rounded-2xl p-3 shrink-0">
                      <div className="flex items-center justify-between mb-2">
                         ...
                         <span className="text-xl font-[1000] italic text-rose-600">{progressPercent}%</span>
                      </div>
                      <div className="w-full h-2 bg-white rounded-full overflow-hidden shadow-inner">
                         <div className="h-full bg-gradient-to-r from-rose-400 to-rose-600 transition-all duration-700" style={{ width: `${progressPercent}%` }} />
                      </div>
                   </div>
                   ...
                   <div className="bg-slate-50/30 border border-slate-100 rounded-2xl p-3 shrink-0">
                      <h3 className="text-[0.625rem] font-black text-rose-600 uppercase tracking-widest italic mb-2 flex items-center gap-2">
                         <span className="w-1 h-3 bg-rose-500 rounded-full" /> MISSION GUIDE
                      </h3>
                      <div className="space-y-1.5">
                         <p className="text-[0.625rem] font-bold text-slate-500 leading-tight tracking-tighter">
                            엑셀로 출제된 지식 서바이벌 퀴즈 게임
                         </p>
                         <p className="text-[0.625rem] font-bold text-slate-500 leading-tight tracking-tighter">
                            모드/문항수 설정 후 엑셀 업로드하고 시작
                         </p>
                      </div>
                   </div>
