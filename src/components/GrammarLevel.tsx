...
export default function GrammarLevel({ onBack, maxLevel = 10, user }: GrammarLevelProps) {
   ...
   if (gameState === 'result') {
      return (
         <div className="fixed inset-0 z-[100] bg-[#14120c]/95 backdrop-blur-3xl flex items-center justify-center p-6 animate-in fade-in duration-700 font-sans">
            <div className="bg-white border-[12px] border-amber-500/20 rounded-[3rem] p-10 lg:p-14 max-w-xl w-full text-center shadow-2xl relative animate-in zoom-in-95">
               <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-32 h-32 bg-amber-600 rounded-full border-8 border-white flex items-center justify-center text-5xl shadow-xl">🏆</div>
               ...
               <div className="bg-amber-50 rounded-[2rem] p-8 mb-10 text-left border border-amber-100 shadow-inner">
               ...
               <div className="flex gap-4">
                  ...
                  <button onClick={onBack} className="flex-1 py-5 rounded-[2rem] bg-amber-600 text-white font-black uppercase tracking-widest text-lg hover:bg-amber-700 shadow-xl transition-all">대시보드</button>
               </div>
            </div>
         </div>
      );
